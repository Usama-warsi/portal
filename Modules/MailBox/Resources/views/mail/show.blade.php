...
@push('css')
    ...
    @if ((isset($company_settings['site_rtl']) ? $company_settings['site_rtl'] : 'off') == 'on')
        <link rel="stylesheet" href="{{ asset('Modules/MailBox/Resources/assets/css/custom-rtl.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/MailBox/Resources/assets/css/custom.css') }}">
    @endif
@endpush
@php
