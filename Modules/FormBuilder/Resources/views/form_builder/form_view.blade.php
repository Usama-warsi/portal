...
<body
    class="{{ !empty(company_setting('color', $company_id, $workspace_id)) ? company_setting('color', $company_id, $workspace_id) : 'theme-1' }}">
    <!-- [ auth-signup ] start -->
                ...
                <div class="col-xl-6 text-center">
                    <div class="mx-3 mx-md-5">
                        <h2 class="mb-3 text-white f-w-600"><img
                                src="{{ !empty($dark_logo) ? $dark_logo : 'logo-dark.png' }}"
                                alt="{{ config('app.name', 'Workdo Crm') }}" class="navbar-brand-img"
                                style="max-width: 250px;"></h2>
                    </div>
                    <div class="card">
