...
@section('content')
    <div class="row">
        {{ Form::open(array('route' => 'course_orders.store','id'=>'frmTarget','method' =>'post')) }}
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('course_number', '', ['class' => 'form-control', 'required' => 'required']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function SectionGet(student_id) {
