    ...
    <div class="row">
        ...
        <div @if(\Auth::user()->type == 'company')class="col-6" @else class="col-4" @endif>
            <div class="form-group">
                ...
                {{ Form::date('date', $date, ['class' => 'form-control date', 'placeholder' => 'Date', 'required' => 'required', 'max' => \Carbon\Carbon::now()->toDateString(), 'id' => 'date-input']) }}
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
                {{ Form::label('hours',__('Hours'),['class'=>'col-form-label']) }}
                {{ Form::select('hours',[1], null, array('class' => 'form-control hours','required'=>'required')) }}
            </div>
        </div>
        <div class="col-4">
            <div class="form-group">
