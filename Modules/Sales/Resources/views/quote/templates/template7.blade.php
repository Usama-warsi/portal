...
<head>
    ...
    <title>{{ Modules\Sales\Entities\Quote::quoteNumberFormat($quote->quote_id, $quote->created_by, $quote->workspace) }}
        |
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number: ') }}</td>
                                        <td class="text-right">
                                            {{ Modules\Sales\Entities\Quote::quoteNumberFormat($quote->quote_id, $quote->created_by, $quote->workspace) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Issue Date:') }}</td>
