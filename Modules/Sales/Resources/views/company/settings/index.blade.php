                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-header card-body">
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between">
                                    {{ Form::label('quote_qr_display', __('QR Display?'), ['class' => 'form-label']) }}
                                    <div class="text-end form-check form-switch d-inline-block">
                                        <input type="checkbox" class="form-check-input"
                                        name="quote_qr_display" id="quote_qr_display"
                                        {{ (isset($settings['quote_qr_display']) ? $settings['quote_qr_display'] : 'off') == 'on' ? 'checked' : '' }}>
                                    </div>
                                </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-header card-body">
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between">
                                    {{ Form::label('salesorder_qr_display', __('QR Display?'), ['class' => 'form-label']) }}
                                    <div class="text-end form-check form-switch d-inline-block">
                                        <input type="checkbox" class="form-check-input"
                                        name="salesorder_qr_display" id="salesorder_qr_display"
                                        {{ (isset($settings['salesorder_qr_display']) ? $settings['salesorder_qr_display'] : 'off') == 'on' ? 'checked' : '' }}>
                                    </div>
                                </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-header card-body">
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between">
                                    {{ Form::label('sales_invoice_qr_display', __('QR Display?'), ['class' => 'form-label']) }}
                                    <div class="text-end form-check form-switch d-inline-block">
                                        <input type="checkbox" class="form-check-input"
                                        name="sales_invoice_qr_display" id="sales_invoice_qr_display"
                                        {{ (isset($settings['sales_invoice_qr_display']) ? $settings['sales_invoice_qr_display'] : 'off') == 'on' ? 'checked' : '' }}>
                                    </div>
                                </div>
                            <div class="form-group">
