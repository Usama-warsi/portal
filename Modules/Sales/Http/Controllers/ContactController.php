...
class ContactController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        {
            $contacts = Contact::with('assign_user')->where('created_by', creatorId())->where('workspace',getActiveWorkSpace())->get();
    ...
    public function create($type, $id)
    {
        if(\Auth::user()->isAbleTo('contact create'))
        {
            ...
            if(module_is_active('CustomField')){
                $customFields =  \Modules\CustomField\Entities\CustomField::where('workspace_id',getActiveWorkSpace())->where('module', '=', 'sales')->where('sub_module','Contact')->get();
            }else{
                $customFields = null;
            }
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->isAbleTo('contact create'))
        {
            ...
            if(module_is_active('CustomField'))
            {
                \Modules\CustomField\Entities\CustomField::saveData($contact, $request->customField);
            }
    ...
    public function show(Contact $contact)
    {
        ...
        {
            if(module_is_active('CustomField')){
                $contact->customField = \Modules\CustomField\Entities\CustomField::getData($contact, 'Sales','Contact');
                $customFields      = \Modules\CustomField\Entities\CustomField::where('workspace_id', '=', getActiveWorkSpace())->where('module', '=', 'Sales')->where('sub_module','Contact')->get();
            }else{
                $customFields = null;
            }
    ...
    public function destroy(Contact $contact)
    {
        if(\Auth::user()->isAbleTo('contact delete'))
        {
            if(module_is_active('CustomField'))
            {
                $customFields = \Modules\CustomField\Entities\CustomField::where('module','sales')->where('sub_module','Contact')->get();
                foreach($customFields as $customField)
                {
                    $value = \Modules\CustomField\Entities\CustomFieldValue::where('record_id', '=', $contact->id)->where('field_id',$customField->id)->first();
                    if(!empty($value)){
                        $value->delete();
                    }
                }
