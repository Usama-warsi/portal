...
class QuoteController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $quotes = Quote::with(['accounts','assign_user'])->where('created_by', creatorId())->where('workspace',getActiveWorkSpace())->get();
    ...
    public function edit(Quote $quote)
    {
        if(\Auth::user()->isAbleTo('quote edit'))
        {
            ...
            if(module_is_active('CustomField')){
                $quote->customField = \Modules\CustomField\Entities\CustomField::getData($quote, 'HospitalManagement','Doctor');
                $customFields             = \Modules\CustomField\Entities\CustomField::where('workspace_id', '=', getActiveWorkSpace())->where('module', '=', 'HospitalManagement')->where('sub_module','Doctor')->get();
            }else{
                $customFields = null;
            }
    ...
    public function destroy(Quote $quote)
    {
        if(\Auth::user()->isAbleTo('quote delete'))
        {
            if(module_is_active('CustomField'))
            {
                $customFields = \Modules\CustomField\Entities\CustomField::where('module','HospitalManagement')->where('sub_module','Doctor')->get();
            ...
            return redirect()->back()->with('success', __('Quote Successfully delete.'));
        }
        else
        {
            return redirect()->back()->with('error', 'permission Denied');
