...
<head>
    ...
    <meta name="title" content="{{ !empty($settings['meta_title']) ? $settings['meta_title'] : 'Portal Dev Connect Hub' }}">
    <meta name="keywords" content="{{ !empty($settings['meta_keywords']) ? $settings['meta_keywords'] : 'Portal Dev Connect Hub,SaaS solution,Multi-workspace' }}">
    <meta name="description" content="{{ !empty($settings['meta_description']) ? $settings['meta_description'] : ''}}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ env('APP_URL') }}">
    <meta property="og:title" content="{{ !empty($settings['meta_title']) ? $settings['meta_title'] : 'Portal Dev Connect Hub' }}">
    ...
    <meta property="twitter:title" content="{{ !empty($settings['meta_title']) ? $settings['meta_title'] : 'Portal Dev Connect Hub' }}">
                                        ...
                                        <ul>
                                            @if (isset($value['footer_section_text']) || !empty($value['footer_section_text']))
                                                @foreach ($value['footer_section_text'] as $key => $text)
                                                        <li><a class="text-white" href="{{ $text['link'] }}">{{ $text['title'] }}</a></li>
                                                @endforeach
                                            @endif
                                        </ul>
                                    </div>
