...
use Modules\MedicalLabManagement\Events\UpdatePatientCard;

class UpdatePatientCardLis
{
    /**
     ...
     * @return void
     */
    public function handle(UpdatePatientCard $event)
    {
        ...
        $activity['description']    = __('Patient Card Updated of Patient ') . $patient->first_name . __(' ') . $patient->last_name . __(' by the ');
