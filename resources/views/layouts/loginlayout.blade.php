...
<head>
    ...
    <title>@yield('page-title') | {{ isset($company_settings['title_text']) ? $company_settings['title_text'] : (isset($admin_settings['title_text']) ? $admin_settings['title_text'] :'Portal Dev Connect Hub') }}</title>

    <meta name="title" content="{{ isset($admin_settings['meta_title']) ? $admin_settings['meta_title'] : 'Portal Dev Connect Hub' }}">
    <meta name="keywords" content="{{ isset($admin_settings['meta_keywords']) ? $admin_settings['meta_keywords'] : 'Portal Dev Connect Hub,SaaS solution,Multi-workspace' }}">
    <meta name="description" content="{{ isset($admin_settings['meta_description']) ? $admin_settings['meta_description'] : ''}}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ env('APP_URL') }}">
    <meta property="og:title" content="{{ isset($admin_settings['meta_title']) ? $admin_settings['meta_title'] : 'Portal Dev Connect Hub' }}">
    <meta property="og:description" content="{{ isset($admin_settings['meta_description']) ? $admin_settings['meta_description'] : ''}} ">
    ...
    <meta property="twitter:title" content="{{ isset($admin_settings['meta_title']) ? $admin_settings['meta_title'] : 'Portal Dev Connect Hub' }}">
    <meta property="twitter:description" content="{{ isset($admin_settings['meta_description']) ? $admin_settings['meta_description'] : ''}} ">
    ...
    <div class="auth-wrapper auth-v3">
        ...
        <div class="auth-content">
            <nav class="navbar navbar-expand-md navbar-light default">
                <div class="container-fluid">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        ...
                        @endphp
                        <img src="{{ $logo }}{{'?'.time()}}" alt="{{ config('app.name', 'Portal Dev Connect Hub') }}" class="navbar-brand-img auth-navbar-brand">
                    </a>
            ...
            <div class="auth-footer">
                <div class="container-fluid">
                    <p class="">@if (isset($company_settings['footer_text'])) {{$company_settings['footer_text']}} @elseif (isset($admin_settings['footer_text'])) {{ $admin_settings['footer_text'] }} @else{{__('Copyright')}} &copy; {{ config('app.name', 'Portal Dev Connect Hub') }}@endif{{date('Y')}}</p>
                </div>
            </div>
        </div>
    </div>
