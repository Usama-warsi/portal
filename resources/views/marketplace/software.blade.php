                ...
                <div class="col-lg-9 col-md-7 col-12">
                    <div class="common-banner-content">
                        <div class="section-title text-center">
                            <h2>{{__('All Add-on')}}</h2>
                            <p>{{__('Choose the add-ons that best fit your needs and take your business operations to the next level with Dev Connect Hub!')}}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="product-listing-section padding-bottom">
        <div class="container">
            ...
            <div class="listing-info padding-top ">
                <h2>Expand Your Capabilities with Add-ons</h2>
                <p>Take your Dev Connect Hub experience to the next level with our versatile add-ons. Whether you're managing finances, tracking activity, building forms, or automating workflows, our add-ons are designed to fit your unique business needs. Streamline your processes, improve efficiency, and gain valuable insights—all from one centralized platform.</p>
                <p>With flexible pricing options, including monthly and annual plans, you can choose the package that works best for your budget. From free integrations like PayPal and Stripe to robust tools like CRM and HRM solutions, these add-ons help you unlock new possibilities and grow your business.</p>
                <p> <strong>Upgrade today and experience the full potential of Dev Connect Hub!</strong></p>
            </div>
        </div>
    </section>
</div>
